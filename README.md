...
<p align="center"><img src="docs/screenshots/07-excel.png" width="720" alt="Выгрузка в Excel"><br>Выгрузка в Excel: клиенты × документы, цвет — статус, причина возврата — в примечании</p>
...
Напишите в Telegram **[@ВАШ_НИК](https://t.me/ВАШ_НИК)** — покажу бота на созвоне и оценю доработки под вашу фирму.
...
© 2026 krein15. Все права защищены. Код открыт для ознакомления; использование, копирование и распространение — только с письменного разрешения автора. Подробнее — в [LICENSE](LICENSE).
